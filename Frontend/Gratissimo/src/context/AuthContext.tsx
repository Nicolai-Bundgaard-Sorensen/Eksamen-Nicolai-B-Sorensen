...
export function AuthProvider({ children }: { children: ReactNode }) {
  const [accessToken, setAccessToken] = useState<string | null>(() => readCookie('gratissimo_access_token'))
  const [refreshToken, setRefreshToken] = useState<string | null>(() => readCookie('gratissimo_refresh_token'))
  ...
  function setSession(nextAccessToken: string, nextRefreshToken: string, nextUser: User) {
