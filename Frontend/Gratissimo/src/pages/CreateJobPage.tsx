...
function CreateJobPage() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      .then(
        async ([regionsResponse, categoriesResponse, workTypesResponse]) => {
      ...
      .catch(() =>
        setErrors({ form: "Kunne ikke hente formularens valgmuligheder." }),
      );
  }, [isAuthenticated]);
    ...
    <section className="create-job-page">
      ...
      <header className="create-job-intro">
        ...
        <p>
          ...
          Når du har fundet en frivillig til din forening, kan du blot fjerne
          annoncen igen ved at gå til din side.
        </p>
