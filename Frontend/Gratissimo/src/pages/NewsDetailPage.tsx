...
function NewsDetailPage() {
  ...
  const selectedId =
    Number.isInteger(articleId) && articleId > 0 ? articleId : articles[0]?.id;
        ...
        <article className="news-detail-article">
          {selectedArticle.imageUrl && (
            <img
              ...
              src={imageUrl(selectedArticle.imageUrl) ?? undefined}
              alt=""
            />
          )}
          <div className="news-detail-copy">
            ...
            <p className="news-detail-meta">
              {formatDate(selectedArticle.createdAt)} - {selectedArticle.author}
            </p>
      ...
      <section className="other-news">
        ...
        <div className="other-news-grid">
          {otherArticles.map((article) => (
            ...
            >
              {article.imageUrl && (
                <img src={imageUrl(article.imageUrl) ?? undefined} alt="" />
              )}
              <span>
